...
// My Post Route
router.get("/my-post", ensureAuthenticated, myPost);
router.get("/admin-my-post", ensureAuthenticated, isAdmin, myPostAdmin);
router.get("/update-apartment/:id", ensureAuthenticated, getUpdateForm);
