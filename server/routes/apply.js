...
router.delete("/delete-application/:id", ensureAuthenticated, isAdmin, checkSudoMiddleware, deleteApplication);
router.get("/delete-application/:id", ensureAuthenticated, isAdmin, checkSudoMiddleware, deleteApplication);
